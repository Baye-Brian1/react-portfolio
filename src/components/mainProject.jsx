...
function MainProject() {
  return(
    <section className="max-w-4xl min-h-screen mx-auto text-gray-700 dark:text-gray-400 p-5 pt-20">
      <h1 className="text-gray-900 dark:text-white text-xl mb-10">Projects !</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 p-5 md:px-16 gap-5">
        ...
        <div className="cursor-pointer p-1.5 rounded-xl border border-gray-300 dark:border-gray-800 w-full h-[250px] text-left bg-white dark:bg-gray-900/50 shadow-md dark:shadow-none hover:border-gray-400 dark:hover:border-gray-700 transition"
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-50 mb-[-10px] text-lg pl-1.5">E-commerce Landing Page</h3>
          <p className="text-sm pl-1.5 text-gray-600 dark:text-gray-400">Interactive E-commerce Landing page</p>
        </div>
        ...
        <div className="cursor-pointer p-1.5 rounded-xl border border-gray-300 dark:border-gray-800 w-full h-[250px] text-left bg-white dark:bg-gray-900/50 shadow-md dark:shadow-none hover:border-gray-400 dark:hover:border-gray-700 transition"
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-50 mb-[-10px] text-lg pl-1.5">Task scheduler</h3>
          <p className="text-sm pl-1.5 text-gray-600 dark:text-gray-400">Schedule your various Tasks</p>
        </div>
        ...
        <div className="cursor-pointer p-1.5 rounded-xl border border-gray-300 dark:border-gray-800 w-full h-[250px] text-left bg-white dark:bg-gray-900/50 shadow-md dark:shadow-none hover:border-gray-400 dark:hover:border-gray-700 transition"
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-50 mb-[-10px] text-lg pl-1.5">Restaurant</h3>
          <p className="text-sm pl-1.5 text-gray-600 dark:text-gray-400">Responsive UI built with Tailwind CSS</p>
        </div>
        ...
        <div className="cursor-pointer p-1.5 rounded-xl border border-gray-300 dark:border-gray-800 w-full h-[250px] text-left bg-white dark:bg-gray-900/50 shadow-md dark:shadow-none hover:border-gray-400 dark:hover:border-gray-700 transition"
          ...
          <p className="text-sm pl-1.5 text-gray-600 dark:text-gray-400">Visit My Github</p>
        </div>
      </div>
    </section>
  );
